...
const lessons = [
  "In the remote year of 1054, a very strange light was visible on the earthling sky.\nWhat was mistaken for a \"guest star\" was, in fact, the supernova that gave rise to this remarkable nebula.",
  "To aid in understanding the origins of the supernova remnant, the newly captured data from the James Webb telescope has allowed us to more clearly identify the elements that make up the fragments of this past explosion.",
  "This is made possible by its two powerful instruments, the NIRCam (Near Infrared Camera) and the MIRI (Mid Infrared Instrument), which have enabled the collection of details never seen before.",
  "The Red components represent previously unseen dust emissions. The Green highlights regions of doubly ionized sulfur, which creates yellow-white areas when overlapped with dust.",
